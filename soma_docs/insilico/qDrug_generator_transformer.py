...
if data_set == 0:
    ...
    path_to_dataset = (
        "data/KRAS_G12D/merged_dataset/1Mstoned_vsc_initial_dataset_insilico_chemistry42_filtered.csv"
    )
...
experiment = LegacyExperiment(run_id=f"MolPAT-{run_date_time}")
