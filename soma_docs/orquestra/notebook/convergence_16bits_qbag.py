...
if __name__ == "__main__":
    ...
    study = optuna.load_study(
        study_name=f"optuna_{N_QUBITS}bits_qbag_syba",
        storage=f"sqlite:///optuna_{N_QUBITS}bits_qbag_syba.db",
    )
    ...
    result = codecarbon_lstm_model(
        "qbag",
        N_QUBITS,
        {"J": J0, "phi": phi0, "x_simple_anneal_time": x_simple_anneal_time},
